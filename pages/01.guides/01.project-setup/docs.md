...
4. Things that came up in install:
...
/usr/local/lib/grav-util/Makefile:27: recipe for target 'docs-user' failed
make: *** [docs-user] Error 126
echute@rtfm:/home/im4us/public_html$ sudo grav-util project-lab USER_NAME=im4us
...
7. Okay, I'm kinda of over this now… probably gonna commit changes to this Guide and call it.
